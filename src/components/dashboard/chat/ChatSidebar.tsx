...
const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  const getAvatarContent = (chat: ChatListItem) => {
    if (chat.type === "admin") {
      return (
        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-red-500 to-red-600 text-white flex items-center justify-center text-sm font-bold shadow-lg">
          A
        </div>
      );
    }
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {chat.unreadCount > 0 && (
                          <span className="ml-2 px-2 py-1 text-xs font-medium text-white bg-primary rounded-full min-w-[20px] text-center">
