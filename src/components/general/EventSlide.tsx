    ...
    <div
      className={`relative w-full bg-transparent overflow-hidden flex ${
        isRTL 
          ? "flex-row-reverse" 
          : "flex-row"
      } h-[59vh] lg:h-[59vh] xl:h-[59vh] md:h-[50vh] sm:h-[45vh] max-sm:h-[21vh] max-sm:flex-col`}
    >
      {isRTL ? (
        ...
        <>
          ...
          <div 
            className="w-1/3 h-full bg-cover bg-center max-sm:w-full max-sm:h-full"
            style={{ backgroundImage: "url('/assets/events/logo-event.png')" }}
          ></div>

          {/* Right container (background event) */}
          <div 
            className="w-2/3 h-full bg-cover bg-center flex flex-col justify-between text-white max-sm:w-full max-sm:h-full p-8 md:p-6 sm:p-5 max-sm:p-4"
            style={{ backgroundImage: "url('/assets/events/backgroud-event.png')" }}
          >
            {/* Top - Title */}
            <div className="flex justify-start">
              <img
                ...
                className="w-1/2 sm:w-[45%] md:w-2/5 lg:w-1/3 h-auto"
              />
            </div>

            {/* Middle - Text */}
            <div className="text-right flex flex-col gap-2">
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold m-0">
                احتفالًا باليوم الوطني السعودي
              </p>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold m-0">
                <span className="font-black text-white mr-1" style={{
                  fontFamily: 'Arial, Helvetica, sans-serif',
                  fontSize: '1.5em',
                  textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)'
                }}>95</span> اشتراك مجاني
              </p>
            </div>
            ...
            <div className="text-left flex flex-col gap-2">
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-semibold m-0">
                <span className="font-black text-white mr-1" style={{
                  ...
                  fontSize: '1.5em',
                  textShadow: '2px 2px 4px rgba(0, 0, 0, 0.3)'
                }}>95</span> days free subscription
              </p>
            </div>
