...
const NurseryCard = ({ nursery, locale }: { nursery: NurseryResponse; locale: LocaleKey }) => {
  ...
  const shouldShowReadMore = truncatedBranches.isTruncated || truncatedAges.isTruncated;
