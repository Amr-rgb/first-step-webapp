...
export default function ParentDashboardHome() {
  ...
  const upcomingEnrollments = Array.isArray(upcomingEnrollmentsData?.data)
    ? upcomingEnrollmentsData.data
    : [];
  const currentEnrollments = Array.isArray(currentEnrollmentsData?.data)
                    ...
                    >
                      <p className="text-base font-medium text-mid-gray">
                        {t("enrollmentStartsOn", {
                          number: item.reservation_number,
                          date: item.starting_date || item.enrollment_date,
                        })}
                      </p>
                    </div>
                  ))}
                  ...
                  {currentEnrollments.map((item: any) => (
                    ...
                    >
                      <p className="text-base font-medium text-primary-blue">
                        {t("enrollmentEndsOn", {
                          number: item.reservation_number,
                          date: item.ending_date || item.enrollment_date,
                        })}
                      </p>
                    </div>
                  ))}
