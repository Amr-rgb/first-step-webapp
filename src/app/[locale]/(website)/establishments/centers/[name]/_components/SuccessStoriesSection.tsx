...
const PLACEHOLDER_STORIES = [
    {
        ...
        title: "قصة نجاح أولى",
        description: "تفوق ملحوظ في تطوير المهارات",
    },
    {
        id: 2,
        image: "/assets/illustrations/center.png",
        title: "قصة نجاح ثانية",
        description: "إنجاز مميز في البرنامج التعليمي",
    },
    {
        id: 3,
        image: "/assets/illustrations/center.png",
        title: "قصة نجاح ثالثة",
        description: "نمو واضح في الثقة بالنفس",
    },
];
...
const SuccessStoriesSection = () => {
    ...
    const stories: Story[] = PLACEHOLDER_STORIES;
            ...
            <AnimatePresence>
                {isOpen && (
                    <Dialog open={isOpen} onOpenChange={setIsOpen}>
                        <DialogTitle className="sr-only">Success Stories Gallery</DialogTitle>
